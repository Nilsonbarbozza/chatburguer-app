# Prompts para Claude Code — Efeitos faciais · Filtros · Adesivos | PRISM Effects
...
Regras obrigatórias:
- Preserve TODAS as cores: #FFFFFF, #6D6D6D, #255DE4
- Preserve a fonte: Pretendard
- Mantenha o container com max-width: 380px
