# Prompts para Claude Code — Test Shadow Build
...
Regras obrigatórias:
- Preserve TODAS as cores: #0000FF, #000000
...
- Os componentes existentes (navbar, hero, cards, footer) devem continuar funcionando
