# Prompts para Claude Code — Mobile Live Streaming App for Games, VTubers & More | PRISM Live Studio Mobile
...
- Preserve a fonte: var(--font-main)
- Mantenha o container com max-width: 100%
- Mantenha o sistema de layout: Flexbox
- Os componentes existentes (Navbar, Botões / CTA, Footer) devem continuar funcionando
